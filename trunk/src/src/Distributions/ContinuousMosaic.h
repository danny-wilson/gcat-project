 ...
 */
#ifndef _CONTINUOUS_MOSAIC_DISTRIBUTION_H_
#define _CONTINUOUS_MOSAIC_DISTRIBUTION_H_
...
class ContinuousMosaicDistribution : public ContinuousVariable, public CompoundDistribution {
protected:
...
public:
	// Constructor
	ContinuousMosaicDistribution(string name="", DAG* dag=0);
	// Copy constructor
	ContinuousMosaicDistribution(const ContinuousMosaicDistribution& x);
...
#endif // _CONTINUOUS_MOSAIC_DISTRIBUTION_H_
