 ...
 */
#ifndef _ABSOLUTE_TRANSFORM_H_
#define _ABSOLUTE_TRANSFORM_H_
#include <DAG/Transformation.h>
#include <Variables/Continuous.h>

namespace gcat {

class AbsoluteTransform : public ContinuousVariable, public Transformation {
public:
	// Constructor
	AbsoluteTransform(string name="", DAG* dag=0);
	// Copy constructor
	AbsoluteTransform(const AbsoluteTransform& x);
