 ...
 */
#ifndef _INVERSE_GAMMA_DISTRIBUTION_H_
#define _INVERSE_GAMMA_DISTRIBUTION_H_
#include <DAG/Distribution.h>
#include <RandomVariables/Continuous.h>

namespace gcat {

class InverseGammaDistribution : public Distribution {
public:
	// Constructor
	InverseGammaDistribution(string name="", DAG* dag=0);
	// Copy constructor
	InverseGammaDistribution(const InverseGammaDistribution &x);
...
#endif //_INVERSE_GAMMA_DISTRIBUTION_H_
